...
class PAO_Plot:
  ...
  def plot_dos_PAO ( self, fname, title=None, x_lim=None, y_lim=None, vertical=False, col='black' ):
    ...
    '''
    from .file_io import read_dos_PAO
  ...
  def plot_electrical_conductivity_PAO ( self, fname, t_ele=[(0,0),(1,1),(2,2)], vE=None, title='Sigma vs Energy', x_lim=None, y_lim=None, col=[(1,0,0),(0,1,0),(0,0,1)] ):
    '''
    ...
    '''
    from .file_io import read_transport_PAO
    from .plot_functions import plot_tensor
  ...
  def plot_seebeck_PAO ( self, fname, t_ele=[(0,0),(1,1),(2,2)], vE=None, title='Seebeck vs Energy', x_lim=None, y_lim=None, col=[(1,0,0),(0,1,0),(0,0,1)] ):
    '''
